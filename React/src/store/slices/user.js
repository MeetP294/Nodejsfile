...
export const changePassword = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    ...
    const res = await API.request("user/lost-password-reset", {
      body,
...
export const loginWithEmail = createAsyncThunk(
  ...
  async (credentials, thunkAPI) => {
    ...
    if(credentials.email.includes('@')) {
      ...
      body.mail = credentials.email;
    } else {
      body.name = credentials.email;
    }
...
export const editUserDetails = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    ...
    let userPass = (data.password !== "") ? data.password : currentUserCreds.pass;
